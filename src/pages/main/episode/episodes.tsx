        ...
        <div className="relative">
          <div className="absolute -top-32 -right-16 sm:right-0 lg:right-24 xl:right-36 2xl:right-64">
            ...
            >
              ...
              />
              <path
                d="M58.4584 68.6243C58.6251 66.6659 59.0417 64.7076 59.5417 62.7909C60.0001 61.0826 61.1667 59.8743 63.0417 59.7076C64.6251 59.5826 66.3334 61.1659 66.5834 63.2493C66.9167 66.0409 67.2084 68.8743 67.0834 71.6659C66.7084 80.0826 66.1667 88.5409 65.5834 96.9576C65.375 99.7493 65 102.541 64.5417 105.333C64.375 106.291 64.0417 107.291 63.5 108.041C62.0417 110.166 59.3751 109.999 58.3334 107.708C57.7501 106.416 57.5001 104.833 57.5001 103.416C57.2917 98.7493 57.9167 75.5409 58.4584 68.6243Z"
                fill="#CD4631"
              />
            </svg>
          </div>
